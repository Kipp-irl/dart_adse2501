 ...
 * Author: Victor
 * Description: This program demonstrates async/await using a pizza ordering simulation
 */
...
Future<void> checkIngredients(String pizzaType)
{
  return Future.delayed(const Duration(seconds: 1), (){
    ...
    print("✔️ Ingredients available for $pizzaType");
  });
}
